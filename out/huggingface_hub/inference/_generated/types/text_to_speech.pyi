...
TextToSpeechEarlyStoppingEnum: Incomplete
...
class TextToSpeechParameters(BaseInferenceType):
    generate: TextToSpeechGenerationParameters | None = ...
...
class TextToSpeechOutput(BaseInferenceType):
    audio: Any
    sampling_rate: Any
    text_to_speech_output_sampling_rate: float | None = ...
    def __init__(self, audio, sampling_rate, text_to_speech_output_sampling_rate=...) -> None: ...
